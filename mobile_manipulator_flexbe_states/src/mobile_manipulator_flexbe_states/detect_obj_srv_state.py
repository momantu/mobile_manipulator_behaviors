...
class DetectObjState(EventState):
	'''
	The state that the camera detect the object and estimate its pose.
	...
	def __init__(self):
		...
		super(DetectObjState, self).__init__(outcomes = ['continue', 'failed'])


		# The constructor is called when building the state machine, not when actually starting the behavior.
		# Thus, we cannot save the starting time now and will do so later.

		self._srv_topic = "/detect_obj_srv"
