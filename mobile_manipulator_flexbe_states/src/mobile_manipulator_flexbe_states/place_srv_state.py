...
class PlaceState(EventState):
	'''
	The state that the manipulator pick the object.
	...
	def __init__(self):
		...
		super(PlaceState, self).__init__(outcomes = ['continue', 'failed'])


		# The constructor is called when building the state machine, not when actually starting the behavior.
		# Thus, we cannot save the starting time now and will do so later.

		self._srv_topic = "/place_srv"
